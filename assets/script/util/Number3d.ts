...
export class Number3d extends Component {
    ...
    mesh1000:MeshRenderer = null;
    @property(MeshRenderer)
    mesh0100:MeshRenderer = null;
    @property(MeshRenderer)
    mesh0010:MeshRenderer = null;
    @property(MeshRenderer)
    mesh0001:MeshRenderer = null;
    ...
    public setValue(value:number) {
        if (this._value != value) {
            ...
            const digit1000 = Math.floor(value / 1000); value %= 1000;
            const digit100 = Math.floor(value / 100); value %= 100;
            ...
            if (digit1000 > 0) {
                this.mesh1000.node.active = true;
                this.mesh0100.node.active = true;
                this.mesh0010.node.active = true;
                this.mesh0001.node.active = true;
                this.setMatherial(this.mesh1000, digit1000);
                this.setMatherial(this.mesh0100, digit100);
                this.setMatherial(this.mesh0010, digit10);
                this.setMatherial(this.mesh0001, digit01);
            } else if (digit100 > 0) {
